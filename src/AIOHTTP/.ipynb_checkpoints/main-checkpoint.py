...
#from .test_options_api import TestOptionsAPI
...
def data_get_option_setter(dataset_name):
...
def model_get_option_setter(model_name):
...
class BaseOptions():
    ...
    def gather_options(self):
        ...
        model_option_setter = model_get_option_setter(model_name)
...
class TestOptionsAPI(BaseOptions):
